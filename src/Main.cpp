...
int main(int argc, char *argv[])
{
    ...
    /*
    std::cout << "=====  Launch of the NN2 : IRIS =====" << '\n';
    ...
    std::cout << "=====  Launch of the NN2 : IMAGE =====" << '\n';
    NN2 *network4 = new NN2(784, 3, 3, new Sigmoide());
    ApprentissageHiddenLayer<Iris,NN2,150> ap4(network4);
    ap3.apprendre_base(100000,0.1);
    std::cout << "found : " << ap4.evaluer() <<"/60000" << '\n';
    std::cout << "==== END : IMAGE ====" << '\n';
